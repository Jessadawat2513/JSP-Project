...
<div class="viewport">
	...
	<div class="body-wrapper">
		<div class="panel panel-primary">
			<div class="panel-heading"><h4>Faculty Add Data</h4></div>
			<div class="panel-body" align="center">
				<form class="form-horizontal">
					<div class="form-group">
						<label class="control-label col-sm-4">Faculty Name</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="fac_name" placeholder="FACULTY NAME">
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<div class="btn-group">
								<button type="button" class="btn btn-default" onclick="ActionAdd('FacultyAdd')">Add</button>
