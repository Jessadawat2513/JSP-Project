...
<div class="viewport">
	...
	<div class="body-wrapper">
		<div class="panel panel-primary">
			<div class="panel-heading"><h4>Branch Add Data</h4></div>
			<div class="panel-body" align="center">
				<form class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="bra_name" placeholder="ชื่อสาขา">
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<div class="btn-group">
								<button type="button" class="btn btn-default" onclick="BranchAction('BranchAdd','${facultyname.getFacId()}')">Add</button>
