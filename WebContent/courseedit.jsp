...
<div class="viewport">
	...
	<div class="body-wrapper">
		<div class="panel panel-primary">
			<div class="panel-heading"><h4>Course Edit Data</h4></div>
			<div class="panel-body" align="center">
				<form class="form-horizontal">
					<div class="form-group">
						<label class="control-label col-sm-4">Course Code</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="code" value="${courseedit.getCourseCode()}">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Course Name</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="c_name" value="${courseedit.getCourseName()}">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Credit</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="credit" value="${courseedit.getCredit()}">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Status</label>
						<c:choose>
						<c:when test="${courseedit.getStatusId() == 001}">
							<div class="col-sm-1">
						...
						<c:when test="${courseedit.getStatusId() == 002}">
							<div class="col-sm-1">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<div class="btn-group">
								<button type="button" class="btn btn-default" onclick="ActionUpdate('CourseUpdate','${courseedit.getCourseCode()}')">OK</button>
