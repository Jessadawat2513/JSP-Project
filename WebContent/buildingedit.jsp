...
<div class="viewport">
	...
	<div class="body-wrapper">
		<div class="panel panel-primary">
			<div class="panel-heading"><h4>Building Edit Data</h4></div>
			<div class="panel-body" align="center">
				<form class="form-horizontal">
					<div class="form-group">
						<label class="control-label col-sm-4">Building Name</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="b_name" value="${buildingedit.getBuildName()}">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Position</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="position" value="${buildingedit.getBuildPosition()}">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Note</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="note" value="${buildingedit.getNote()}">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Status</label>
						<c:choose>
						<c:when test="${buildingedit.getStatusId() == 001}">
							<div class="col-sm-1">
						...
						<c:when test="${buildingedit.getStatusId() == 002}">
							<div class="col-sm-1">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<div class="btn-group">
								<button type="button" class="btn btn-default" onclick="ActionUpdate('BuildingUpdate','${buildingedit.getBuildId()}')">OK</button>
