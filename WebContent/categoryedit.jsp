...
<div class="viewport">
	...
	<div class="body-wrapper">
		<div class="panel panel-primary">
			<div class="panel-heading"><h4>Category Edit Data</h4></div>
			<div class="panel-body" align="center">
				<form class="form-horizontal">
					<div class="form-group">
						<label class="control-label col-sm-4">Category Name</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="cat_name" value="${categoryedit.getCatName()}">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Status</label>
						<c:choose>
						<c:when test="${categoryedit.getStatusId() == 001}">
							<div class="col-sm-1">
						...
						<c:when test="${categoryedit.getStatusId() == 002}">
							<div class="col-sm-1">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<div class="btn-group">
								<button type="button" class="btn btn-default" onclick="ActionUpdate('CategoryUpdate','${categoryedit.getCatId()}')">OK</button>
								<button type="button" class="btn btn-default" onclick="ActionView('CategoryView')">Back</button>
							</div>
						</div>
					</div>
				</form>
